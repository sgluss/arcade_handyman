...
from toolsmith.ir import APISpec, CallStep, Endpoint, ToolPlan, ToolSpec
...
def render_server(plan: ToolPlan, spec: APISpec, source: str) -> str:
    ...
    env = Environment(loader=PackageLoader("toolsmith", "templates"), keep_trailing_newline=True)
    env.filters["py"] = repr
...
Generated by [Toolsmith](../../README.md) from `{source}`. Do not edit by hand —
